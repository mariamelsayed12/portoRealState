...
const HeaderSection = () => {
  return (
    <section className="relative w-full h-[400px] md:h-[450px] lg:h-[516px]  rounded-b-[50px] md:rounded-b-[70px]     lg:rounded-b-[99px] overflow-visible shadow-xl bg-[#0c1618] z-10">
      {/* Background Image */}
      <img
        src={primaryImage}
