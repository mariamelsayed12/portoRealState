...
const HeaderSection = () => {
  return (
    <section className="relative w-full h-[650px] md:h-[750px] lg:h-[600px]  rounded-b-[50px] md:rounded-b-[70px]     lg:rounded-b-[99px] overflow-visible shadow-xl bg-[#0c1618] z-10">
      {/* Background Image */}
      <img
        src={primaryImage}
   ...
   <h1 className="text-4xl sm:text-5xl md:text-[64px] lg:text-[64px] font-medium text-white tracking-tight leading-[1.3] drop-shadow-md">
...
<div className="relative -mt-20 sm:-mt-24 z-30 w-[95%] sm:w-[90%] max-w-6xl mx-auto px-2 sm:px-4">
    <SearchSection />
      </div>
    </section>
  );
