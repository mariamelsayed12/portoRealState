    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative w-full h-[380px] md:h-[420px] lg:h-[460px] rounded-b-[48px] md:rounded-b-[72px] lg:rounded-b-[80px] overflow-hidden bg-[#0c1618] z-10">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 h-full flex flex-col justify-center pt-16">
          <div className="max-w-3xl">
            ...
            <p className="text-sm sm:text-base md:text-lg text-white/90 font-medium tracking-wide mt-4 max-w-xl drop-shadow-sm leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-20 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Column - Our Agents are waiting */}
          <div className="flex flex-col items-center text-center">
            ...
            <div className="relative flex justify-center items-center w-[280px] sm:w-[320px] md:w-[360px] lg:w-[420px]">
              ...
              <img src={vectorImage} alt="vector" className="absolute text-primary w-14 sm:w-16 md:w-20 lg:w-24 h-auto" />
              {/* <BuildingSellPageIcon className="absolute text-primary w-14 sm:w-16 md:w-20 lg:w-24 h-auto" /> */}
            </div>

            <h2 className="text-3xl md:text-[40px] font-semibold text-text-secondary mt-8 leading-tight">
