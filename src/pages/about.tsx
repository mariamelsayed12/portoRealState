...
const WhatWeOfferCard = ({ label, highlight }: CardProps) => {
  return (
    <div className="bg-white/10 border border-white/10 backdrop-blur-[12px] rounded-[12px] p-[8px] h-[74px] w-full max-w-[181px] flex flex-col justify-center shrink-0">
