...
export const units: PropertyUnitCardData[] = [
  ...
  },
  {
    id: "marina-unit-3",
    image: defualtImage,
    badges: ["Rent", "Delivery in 2027"],
    location: "Porto Marina • Studio",
    title: "Cozy Marina Studio",
    stats: [
      { icon: "area", value: "75 sqm" },
      { icon: "bed", value: "2" },
      { icon: "bath", value: "1" },
    ],
    price: "2,000,000 EGP",
  ...
  },
  {
    id: "beach-unit-3",
    image: defualtImage,
    badges: ["Rent", "Delivery in 2026"],
    location: "Porto Beach • Villa",
    title: "Prime Beach Villa",
    stats: [
      { icon: "area", value: "250 sqm" },
      { icon: "bed", value: "6" },
      { icon: "bath", value: "4" },
    ],
    price: "8,000,000 EGP",
  ...
  },
  {
    ...
    image: defualtImage,
    badges: ["Rent", "Delivery in 2027"],
    location: "Porto Lagoon • Townhouse",
    title: "Lakeside Townhouse",
    stats: [
      { icon: "area", value: "185 sqm" },
      { icon: "bed", value: "4" },
      { icon: "bath", value: "3" },
    ],
    price: "5,000,000 EGP",
  ...
  },
  {
    ...
    badges: ["Rent", "Delivery in 2028"],
    location: "Porto Marina • Penthouse",
    title: "Elite Promenade Penthouse",
    stats: [
      { icon: "area", value: "220 sqm" },
      { icon: "bed", value: "5" },
      { icon: "bath", value: "3" },
    ],
    price: "7,000,000 EGP",
  ...
  },
  {
    id: "coast-unit-3",
    image: defualtImage,
    badges: ["Rent", "Delivery in 2029"],
    location: "Porto Coast • Villa",
    title: "Exclusive Coast Villa",
    stats: [
      { icon: "area", value: "280 sqm" },
      { icon: "bed", value: "6" },
      { icon: "bath", value: "4" },
    ],
    price: "9,500,000 EGP",
